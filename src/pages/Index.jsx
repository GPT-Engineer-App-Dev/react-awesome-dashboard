    ...
    <Container centerContent maxW="container.xl" height="100vh" display="flex" flexDirection="column" justifyContent="center" alignItems="center">
      <Box py={5} pr={5} pl={20} bg="gray.800" borderRadius="30px" w="full" maxW="container.xl">
        <Flex gap={5} direction={{ base: "column", md: "row" }}>
          ...
          <Box flex="3" w={{ base: "full", md: "85%" }} pl={5}>
            <Box bg="white" borderRadius="30px" p={10}>
              <Flex gap={5} direction={{ base: "column", md: "row" }}>
                <Box flex="3">
                  <VStack align="start" spacing={5}>
                    <Box>
                      <Text fontSize="4xl" fontWeight="semibold" color="gray.800">Expenses</Text>
                      <Text mt={4} fontSize="base" color="gray.700">01 - 25 March, 2020</Text>
                    </Box>
                    <Image
                      loading="lazy"
                    ...
                    <VStack align="start" spacing={6}>
                      ...
                      <Flex gap={4}>
                        ...
                        <Box>
                          ...
                          <Text mt={2.5} fontSize="sm" color="gray.600">5:12 pm • Belanja di pasar</Text>
                        </Box>
                      </Flex>
                      <Flex gap={4}>
                        <Image
                        ...
                        <Box>
                          ...
                          <Text mt={2.5} fontSize="sm" color="gray.600">5:12 pm • Naik bus umum</Text>
                        </Box>
                      </Flex>
                      <Flex gap={4}>
                        <Image
                        ...
                        <Box>
                          ...
                          <Text mt={2.5} fontSize="sm" color="gray.600">5:12 pm • Bayar Listrik</Text>
                        </Box>
                      </Flex>
                      ...
                      <Flex gap={4}>
                        ...
                        <Box>
                          ...
                          <Text mt={4} fontSize="sm" color="gray.600">5:12 pm • Makan Steak</Text>
                        </Box>
                      </Flex>
                      <Flex gap={4}>
                        <Image
                        ...
                        <Box>
                          ...
                          <Text mt={3.5} fontSize="sm" color="gray.600">5:12 pm • Nonton Bioskop</Text>
                        </Box>
                      </Flex>
                    </VStack>
                  </Box>
                ...
                <Box flex="1" ml={5}>
                  <VStack align="start" spacing={5} bg="gray.50" p={10} borderRadius="30px">
